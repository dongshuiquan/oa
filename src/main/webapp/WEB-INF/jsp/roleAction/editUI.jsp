            ...
            <div class="ItemBlock">
                <table class="mainForm">
                    <tr>
                        ...
                        <td><s:textfield name="name" cssClass="InputStyle" value="%{model.name}"/> </td>
                    </tr>
                    <tr>
                        <td>岗位说明</td>
                        <td><s:textarea name="description" cssClass="TextareaStyle" value="%{model.description}"></s:textarea></td>
                    </tr>
                </table>
            </div>
        </div>
