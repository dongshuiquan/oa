...
<div id="QueryArea">
	<div style="height: 30px">
		...
		<s:form id="pageForm" action="flowAction_myApplicationList">
    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
		...
		<s:iterator value="recordList">
			<tr class="TableDetail1 template">
				...
				<td>${status}&nbsp;</td>
				<td>
					<s:a action="flowAction_Formflow/showForm.html">查看申请信息</s:a>
...
<script type="text/javascript">
	function gotoPage(pageNum){
		window.location.href="flowAction_myApplicationList.action?pageNum="+pageNum;
	}
</script>
